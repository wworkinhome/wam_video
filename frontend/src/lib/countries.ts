// Códigos ISO 3166-1 alpha-2 usados en Channel.country. El emoji de bandera se
// deriva del código (no hace falta guardar assets de imagen).
export interface Country {
  code: string;
  name: string;
}

// Lista completa ISO 3166-1 alpha-2, nombres en español, orden alfabético.
...
// Emoji de bandera no se renderiza en Windows (fallback a texto plano por diseño de
// la plataforma), así que usamos flagcdn.com para un ícono consistente en cualquier SO.
